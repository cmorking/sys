    ...
    public function add() {
        ...
        if ($this->form_validation->run()) {
            ...
            if ($this->ion_auth->register($username, $password, $email, $additional_data, $group)) {
                ...
                $this->session->set_flashdata('error', 'Erro ao cadastrar usuári!');
            }

            redirect('usuarios');
        } else {

            //erro de validação form validate
...
//		exit();
            ...
            if ($this->form_validation->run()) {
                ...
                /* verifica se foi alterado passwd */
    ...
    public function del($usuario_id = null) {
        ...
        if ($this->ion_auth->is_admin($usuario_id)) {
            ...
            $this->session->set_flashdata('error', 'Um usuário admin, não pode ser deletado!');
            redirect('usuarios');
        }
    ...
    public function email_check($email) {
        ...
        if ($this->core_model->get_by_id('users', array('email' => $email, 'id !=' => $usuario_id))) {
            ...
            $this->form_validation->set_message('email_check', 'O e-mail informado já está cadastrado em nossa base de dados, informe outro!');
    ...
    public function username_check($username) {
        ...
        if ($this->core_model->get_by_id('users', array('email' => $username, 'id !=' => $usuario_id))) {

            $this->form_validation->set_message('username_check', 'O usuário informado já está cadastrado em nossa base de dados, informe outro!');
