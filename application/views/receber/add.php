                ...
                <form method="post" name="form_add">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            ...
                            <select class="custom-select contas_receber" name="conta_receber_cliente_id">
                                <?php foreach ($clientes as $cliente): ?>
                                    ...
                                    <option value="<?= $cliente->cliente_id ?>"<?= ($cliente->cliente_ativo == 0 ? 'disabled' : '' ) ?> > <?= $cliente->cliente_nome ?> </option>
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="date" class="form-control"  name="conta_receber_data_vencimento">  
                    ...
                    <div class="form-group row">
                            ...
                            <input type="text" class="form-control"  name="conta_receber_nome"  >
                        ...
                        <div class="col-md-4">
                            ...
                            <select style="height: 38px" class="form-control" name="conta_receber_status">
                                ...
                                <option value="1"> Conta Paga  </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control form-control-user" name="conta_receber_obs" placeholder="Observações" ></textarea>
