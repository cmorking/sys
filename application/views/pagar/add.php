                ...
                <form method="post" name="form_add">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="date" class="form-control"  name="conta_pagar_data_vencimento" >
                    ...
                    <div class="form-group row">
                            ...
                            <input type="text" class="form-control"  name="conta_pagar_nome">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control form-control-user" name="conta_pagar_obs" placeholder="Observações" ></textarea>
