    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="<?= base_url('pagar/add') ?>" class="btn btn-sm btn-success float-right"><i class="fas fa-user-tie"></i> &nbsp;&nbsp;Add&nbsp;&nbsp;</a>
            </div>
            <div class="card-body">
                            ...
                            <?php foreach ($contas_pagar as $conta): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $conta->fornecedor ?></td>
                                     <td><?= $conta->conta_pagar_nome ?></td>
                                    <td><?= $conta->conta_pagar_valor ?></td>
                                    ...
                                    <td class="text-center" style="font-size: 18px">
                                        ...
                                        if ($conta->conta_pagar_status == 1){
                                            ...
                                            echo '<span  class="badge badge-success"> Conta Paga </span>';                                            
                                               ...
                                               echo '<span class="badge badge-info"> A pagar </span>';     
                                    ...
                                    <td class="text-center">
                                        <a title="Editar Registro" href="<?= base_url('pagar/edit/' . $conta->conta_pagar_id); ?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></i> </a>
                                        <a title="Deletar Registro" href="javascript(void)" data-toggle="modal" data-target="#conta-<?= $conta->conta_pagar_id; ?>" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i> </a>
